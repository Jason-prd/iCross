...
class TestOzonAdapterInitialization:
    ...
    def test_adapter_creation(self):
        ...
        adapter = OzonIntegrationAdapter(client_id="123456", api_key="test_api_key")
...
class TestOzonExceptions:
    ...
    def test_ozon_integration_error(self):
        ...
        error = OzonIntegrationError(message="Test error message", code="TEST_ERROR")
    ...
    def test_ozon_authentication_error(self):
        ...
        error = OzonAuthenticationError(message="Authentication failed")
    ...
    def test_ozon_rate_limit_error(self):
        ...
        assert "rate limit" in str(error).lower() or "limit" in str(error).lower()
...
class TestOzonConfig:
    ...
    def test_config_loading(self):
        ...
        config = OzonConfig(client_id="123456", api_key="test_key")
